...
# preventing new cups instagit puch origin masterllations to work.
#
...
#
# This script requires a working or legacy cups installation.
...
ssh $user_name@$print_host 'lpr '$FILE''root@ryzen:/home/davidh/dev-2022/utilities/print_remote# 
